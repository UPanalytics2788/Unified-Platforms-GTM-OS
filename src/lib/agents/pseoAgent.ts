...
export const runPSEOContentAgent = async (template: any, location: any) => {
  const SYSTEM = `You are the "Lead Architect" for Unified Platforms. Your task is to generate structured data for a programmatic CMS feature that builds high-end service pages.

...
export default function CaseStudies() {
  ...
  return (
    <div className="py-20 bg-brand-white min-h-screen">
      <SEO 
        title="Case Studies | Unified Platforms"
        description="Real results for real companies. See how we've helped our clients scale their growth across various industries."
      />

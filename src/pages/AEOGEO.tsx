...
export default function AEOGEO() {
  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-brand-primary/30">
      <SEO 
        title={service?.meta_title || 'AEO & GEO Optimization | AI Answer Dominance | GTM OS'} 
        description={service?.meta_description || 'Secure your brand citations in AI search results (ChatGPT, Perplexity, Gemini). GTM OS delivers technical AEO/GEO for the generative search era.'} 
      />

...
export default function MarketplaceAds() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <SEO 
        title={pageData?.meta_title || "Marketplace Ads Management | Amazon, Flipkart, Meesho Advertising | Unified Platforms"}
        description={pageData?.meta_description || "Grow sales on Amazon, Flipkart, and other marketplace platforms with expert ad management. Unified Platforms runs marketplace advertising campaigns that improve visibility and drive profitable sales."}
      />

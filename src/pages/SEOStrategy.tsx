        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
               <h3 className="text-2xl font-bold text-brand-dark mb-6 tracking-tight">Comparison: The Unified Platforms approach</h3>
               <div className="space-y-4">
                 {[
                   { label: "Generic SEO", value: "Tactical keyword stuffing and backlink spam.", color: "text-red-500" },
                   { label: "Unified Platforms Strategy", value: "Strategic topic clustering mapped to search intent and revenue.", color: "text-brand-primary" }
                 ].map((item, i) => (
